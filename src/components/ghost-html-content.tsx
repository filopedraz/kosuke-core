...
export function GhostHtmlContent({ html, className = '' }: GhostHtmlContentProps) {
  ...
  return (
    <article
      className={`font-sans prose prose-lg dark:prose-invert
        prose-headings:font-bold prose-headings:tracking-tight prose-headings:text-foreground
        prose-h1:text-4xl prose-h1:font-semibold prose-h1:mb-6 prose-h1:mt-12 prose-h1:leading-tight
        prose-h2:text-3xl prose-h2:font-semibold prose-h2:mb-6 prose-h2:mt-12 prose-h2:leading-tight
        ...
        [&_h2]:text-3xl [&_h2]:font-semibold [&_h2]:mb-6 [&_h2]:mt-12 [&_h2]:text-foreground
