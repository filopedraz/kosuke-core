    ...
    <section className="pt-12 sm:pt-20 pb-16 sm:pb-32">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="absolute inset-0 bg-linear-to-brvia-transparent rounded-2xl blur-3xl pointer-events-none" />
          ...
          >
            ...
            <p className="text-base sm:text-lg lg:text-xl text-muted-foreground max-w-3xl mx-auto font-sans leading-relaxed">
              ...
              Real accountability, transparent pricing, and shipped products—not endless prototypes.
            </p>
