        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-muted-foreground max-w-3xl mx-auto font-sans px-2">
              AI-powered development with expert engineering oversight to ensure quality and
              reliability.
            </p>
          </motion.div>

          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-8 md:mt-16 *:text-center">
