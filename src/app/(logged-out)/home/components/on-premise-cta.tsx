        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl sm:leading-tight font-bold leading-tight tracking-tight">
                The First{' '}
              ...
              <p className="text-base md:text-lg lg:text-xl text-muted-foreground font-sans leading-relaxed">
                ...
                data privacy. Deploy on your infrastructure with complete control.
              </p>
              ...
              >
                ...
                >
                  <Link href="/solutions/on-premise">Learn More</Link>
                </Button>
              </motion.div>
            </motion.div>
