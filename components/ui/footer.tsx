...
export default function Footer() {
  return (
    ...
    >
      <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 backdrop-blur-sm bg-background/30 px-6 py-4 sm:py-3 rounded-2xl sm:rounded-full border border-border/30">
        {/* Legal Links */}
        ...
        <div className="h-px w-12 sm:h-4 sm:w-px bg-border/50"></div>
